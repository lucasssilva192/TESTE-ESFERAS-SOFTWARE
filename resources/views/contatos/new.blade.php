                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="sobrenome" name="sobrenome" placeholder="Ex.: Santos" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="telefone" name="telefone" placeholder="Ex.: (11)91234-5678" maxlength="11" required>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                <label for="cpf">CPF:</label>
                                <input type="text" class="form-control" id="cpf" name="cpf" placeholder="Ex.: 123.123.123-12">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="email">E-Mail:</label>
                        <input type="email" class="form-control" id="email" name="email" placeholder="Ex.: joao.santos@gmail.com">
                    </div>
